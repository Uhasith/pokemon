<x-app-layout>
    <div class="w-full bg-darkblackbg">
            ...
            <div class="flex gap-4 flex-col lg:flex-row lg:flex-wrap xl:flex-nowrap items-center lg:items-start">
                ...
                <div class="w-4/5 lg:w-3/12 xl:w-[25%] xl:mx-auto">
                    ...
                    <div class="flex gap-3 my-3 flex-col xl:flex-row">
                        <button class="w-full xl:w-1/2 bg-yellowish rounded-lg text-center flex gap-3 items-center justify-center marker p-2 xl:p-3">
                ...
                <div class="w-4/5 mx-auto lg:w-8/12 xl:w-[60%] xl:px-3 lg:ml-8 xl:ml-5">
                    <div>
                        <h1 class="font-manrope text-3xl lg:text-4xl font-bold text-white">Pikachu - SV05: Temporal Forces (TEF)</h1>
                    </div>
                            ...
                            <div class="hidden" id="styled-prices" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="relative overflow-x-auto sm:rounded-lg">
                                    ...
                                    <div class="w-full flex flex-col md:flex-row gap-5 my-5">
                                        <div class="w-full md:w-9/12 bg-[#27292B] rounded-xl p-4 overflow-x-auto relative flex flex-col justify-between">
                                            <div class="w-full relative overflow-x-auto">
                                                <div class="flex justify-start w-full mb-3">
                                                    <h2 class="font-manrope font-bold text-base text-white">PSA Population price</h2>
                                                </div>
                                                <div class="flex gap-4 w-full">
                                                    ...
                                                    <div class="w-1/4 flex flex-col gap-2 justify-between">
                                                        ...
                                                        <h4 class="font-manrope font-semibold text-sm text-redprice">Very Hard</h4>
                                                    </div>
                                                </div>
                                                <hr class="my-2">
                                                <div class="grid grid-cols-10 gap-4 w-full">
                                        ...
                                        <div class="w-full md:w-3/12 bg-[#27292B] rounded-xl p-4 relative overflow-x-auto">
                                            <div class="flex justify-center w-full mb-3 flex-col gap-1 items-start">
        ...
        <div class="w-full bg-blackish py-12">
            <div class="max-w-[1440px] 2xl:max-w-[1500px] bg-blackish flex relative mx-auto flex-col xl:flex-row gap-12 items-center justify-center px-8 xl:px-0">
                <div class="w-full xl:w-10/12">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 xl:table-fixed">
                            <thead class="text-xs text-white uppercase bg-evengray">
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-yellowish font-manrope font-semibold text-sm normal-case w-auto xl:w-[13%]">
                                        Sale Price (USD)
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-yellowish font-manrope font-semibold text-sm normal-case w-auto xl:w-[7%]">
                                        Grade
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-yellowish font-manrope font-semibold text-sm normal-case w-auto xl:w-[10%]">
                                        #Bids
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-yellowish font-manrope font-semibold text-sm normal-case w-auto xl:w-[12%]">
                                        Date Sold
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-yellowish font-manrope font-semibold text-sm normal-case">
                                        Listing ID
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-yellowish font-manrope font-semibold text-sm normal-case w-auto xl:w-[30%]">
                                        Title
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-yellowish font-manrope font-semibold text-sm normal-case w-auto xl:w-[8%]">
        ...
        <div class="w-full bg-darkblackbg py-12">
            <div class="max-w-[1440px] 2xl:max-w-[1500px] bg-darkblackbg flex relative mx-auto flex-col xl:flex-row gap-12 items-center justify-center">
                <div class="w-full xl:w-10/12 px-8 xl:px-0">
                    <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-4 gap-y-5 items-center justify-center">
                        {{-- Item - 01 --}}
        ...
        {{-- Fourth Section --}}
        <div class="w-full bg-blackish py-12">
            <div class="max-w-[1440px] 2xl:max-w-[1500px] bg-blackish flex relative mx-auto flex-col xl:flex-row gap-12 items-center justify-center">
                <div class="w-full xl:w-10/12 px-8 xl:px-0">
                    <div>
                        <h2 class="font-manrope font-bold text-center text-2xl lg:text-3xl text-white">Similar Cards to Pikachu</h2>
                    </div>
                    ...
                    <div class="mt-8">
                        <h2 class="font-manrope font-bold text-center text-2xl lg:text-3xl text-white">Similar Cards from Wizards Black Star Promos </h2>
                    </div>
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 my-12">
                        <div class="flex w-full">
                            <div class="p-6 rounded-2xl bg-[#2C2C2C] bg-blend-screen">
        ...
        <div class="w-full bg-darkblackbg py-12">
            <div class="max-w-[1440px] 2xl:max-w-[1500px] bg-darkblackbg flex relative mx-auto flex-col xl:flex-row gap-12 items-center justify-center">
                <div class="w-full xl:w-10/12 px-8 xl:px-0">
                    <div class="mt-8">
                        <h2 class="font-manrope font-bold text-center text-2xl lg:text-3xl text-white">Auctions ending soon for Pikachu - SV05: Temporal Forces (TEF)</h2>
                    </div>
                    <div class="my-8">
                        <div class="mb-4">
                                ...
                                <div class="grid gap-5 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                                    ...
                                    <div class="flex gap-5 items-center w-full rounded-lg bg-[#262626] p-5">
                                        ...
                                        <div class="w-2/3 relative">
                                            <div class="flex items-center justify-center gap-2 w-full h-10 bg-no-repeat bg-center bg-contain absolute -top-14 md:-top-9 lg:-top-14 xl:-top-11" style="background-image: url('{{ asset('assets/card-images/timebanner.png') }}');">
