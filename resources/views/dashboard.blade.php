<x-app-layout>
    <div class="w-full bg-darkblackbg">
        ...
        <div class="max-w-[1440px] bg-darkbg mx-auto relative flex flex-col lg:px-8 xl:px-0">
            ...
            <div class="flex gap-4 flex-col lg:flex-row lg:flex-wrap xl:flex-nowrap items-center lg:items-start">
                {{-- left Image section --}}
                <div class="w-4/5 lg:w-3/12 xl:w-3/12 xl:mx-auto">
                    ...
                    <div class="flex gap-3 my-3 flex-col xl:flex-row">
                        ...
                        <button class="w-full xl:w-1/2 border border-yellowish text-yellowish rounded-lg text-center flex gap-2 items-center justify-center p-2">
                ...
                <div class="w-4/5 mx-auto lg:w-8/12 xl:w-7/12 xl:px-3 lg:ml-8 xl:ml-5">
                    <div>
                ...
                <div class="hidden lg:block lg:w-full xl:w-2/12 h-full xl:h-fit ml-2 mb-5 xl:mb-0">
        ...
        <div class="w-full bg-blackish py-12">
            <div class="max-w-[1440px] bg-blackish flex relative mx-auto flex-col xl:flex-row gap-12 items-center justify-center px-8 xl:px-0">
        ...
        <div class="w-full bg-darkblackbg py-12">
            <div class="max-w-[1440px] bg-darkblackbg flex relative mx-auto flex-col xl:flex-row gap-12 items-center justify-center">
                <div class="w-full xl:w-10/12 px-8 xl:px-0">
                    <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 items-center justify-center">
                        {{-- Item - 01 --}}
        ...
        {{-- Fourth Section --}}
        <div class="w-full bg-blackish py-12">
            <div class="max-w-[1440px] bg-blackish flex relative mx-auto flex-col xl:flex-row gap-12 items-center justify-center">
                <div class="w-full xl:w-10/12 px-8 xl:px-0">
                    <div>
