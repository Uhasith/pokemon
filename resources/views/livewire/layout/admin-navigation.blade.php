...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="{{ route('set-index') }}" :active="request()->routeIs('set-index')" wire:navigate>
                        {{ __('Home') }}
                    </x-nav-link>
                    <x-nav-link :href="route('set-page')" :active="request()->routeIs('set-page')" wire:navigate>
                        {{ __('Sets') }}
                    </x-nav-link>
                    <x-nav-link :href="route('card-page')" :active="request()->routeIs('card-page')" wire:navigate>
                        {{ __('Cards') }}
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('set-details', ['set_id' => '6763889C-2A51-48F5-B540-01626C1345C2'])" :active="request()->routeIs('home')" wire:navigate>
                {{ __('Home') }}
