        ...
        <div class="flex justify-between h-16">
            <div class="flex w-full xl:w-1/2">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex ">
                    <x-nav-link class="text-white font-manrope text-base font-medium" :href="route('home')" :active="request()->routeIs('home')"
                        wire:navigate>
                        {{ __('Home') }}
                    </x-nav-link>
                    ...
                    <form class="mx-auto">
                        ...
                        <div class="relative">
                            <input type="search" id="default-search"
                                class="block w-auto h-12 m-2 text-sm text-gray-900 rounded-lg bg-[#FFFFFF14] border-0"
                                placeholder="Find a card..." required />
                            <button type="submit"
