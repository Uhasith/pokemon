...
<nav x-data="{ menuOpen: false }" class="bg-blackish border-b border-[#27292B]">
            ...
            <div class="-me-2 flex items-center md:hidden">
                <button @click="menuOpen = ! menuOpen"
                    ...
                    <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                        <path :class="{ 'hidden': menuOpen, 'inline-flex': !menuOpen }" class="inline-flex"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16" />
                        <path :class="{ 'hidden': !menuOpen, 'inline-flex': menuOpen }" class="hidden" stroke-linecap="round"
