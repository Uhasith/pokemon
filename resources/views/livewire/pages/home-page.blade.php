                ...
                <div class="w-full md:w-9/12 xl:w-4/5">
                    <div class="flex items-center justify-end gap-4">
                        ...
                        <div class="bg-[#383A3C] flex items-center p-1.5 rounded-md gap-3">
                            <button class="{{$viewType == 'list' ? 'bg-yellowish p-1.5 rounded' : 'p-1.5 rounded'}}" x-on:click="$wire.set('viewType', 'list')">
                                <svg width="24" height="20" viewBox="0 0 34 30" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.66602 9L24.3327 9" stroke="{{$viewType == 'list' ? '#1B1B1B' : 'white'}}" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M9.66602 15L24.3327 15" stroke="{{$viewType == 'list' ? '#1B1B1B' : 'white'}}" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M9.66602 21L24.3327 21" stroke="{{$viewType == 'list' ? '#1B1B1B' : 'white'}}" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </button>
                            <button class="{{$viewType == 'grid' ? 'bg-yellowish p-1.5 rounded' : 'p-1.5 rounded'}}" x-on:click="$wire.set('viewType', 'grid')">
                                <svg width="24" height="20" viewBox="0 0 20 20" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="{{$viewType == 'grid' ? '#1B1B1B' : 'white'}}" />
                                    <path
                    ...
                    @if ($viewType == 'grid')
                        {{-- This is Grid View --}}
                        <div wire:transition wire:key="grid-view">
                            <div class="grid gap-8 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 my-5">
                                ...
                                <div class="w-full">
                                    ...
                                    <h2 class="font-manrope font-bold text-sm xl:text-base text-white mt-2">Iron Thorns
                                        -
                                        SV05: Temporal Forces (TEF)</h2>
                                    <div class="flex justify-between items-center mt-2">
                                        <p class="font-manrope text-yellowish text-sm xl:text-base font-semibold">Price
                                            :
                                        </p>
                                ...
                                <div class="w-full">
                                    <div class="flex w-full">
                                        ...
                                        <div class="relative">
                                            <div
                                                class="bg-[#555555e3] p-2 rounded-full w-auto absolute top-[10px] -ml-[50px]">
                                                <svg width="20" height="20" viewBox="0 0 20 20"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M9.99935 6.66675V13.3334M13.3327 10.0001L6.66602 10.0001"
                                                        stroke="white" stroke-width="1.27273" stroke-linecap="round"
                                    ...
                                    <h2 class="font-manrope font-bold text-sm xl:text-base text-white mt-2">Flutter
                                        Mane -
                                        SV05: Temporal Forces (TEF)</h2>
                                    <div class="flex justify-between items-center mt-2">
                                        <p class="font-manrope text-yellowish text-sm xl:text-base font-semibold">Price
                                ...
                                <div class="w-full">
                                    ...
                                    <h2 class="font-manrope font-bold text-sm xl:text-base text-white mt-2">Munkidori -
                                        SV06: Twilight Masquerade (TWM)</h2>
                                    <div class="flex justify-between items-center mt-2">
                                        <p class="font-manrope text-yellowish text-sm xl:text-base font-semibold">Price
                                            :
                                        </p>
                                ...
                                <div class="w-full">
                                    ...
                                    <h2 class="font-manrope font-bold text-sm xl:text-base text-white mt-2">Iron
                                        Valiant -
                                        080/162 - SV05: Temporal Forces (TEF)</h2>
                                    <div class="flex justify-between items-center mt-2">
                                        <p class="font-manrope text-yellowish text-sm xl:text-base font-semibold">Price
                                            :
                                        </p>
                                ...
                                <div class="w-full">
                                    ...
                                    <h2 class="font-manrope font-bold text-sm xl:text-base text-white mt-2">Pikachu -
                                        SV05:
                                        Temporal Forces (TEF)</h2>
                                    <div class="flex justify-between items-center mt-2">
                                        <p class="font-manrope text-yellowish text-sm xl:text-base font-semibold">Price
                                            :
                                        </p>
                    ...
                    @else
                        {{-- This is List view --}}
                        <div wire:transition wire:key="list-view">
                                        ...
                                        <tbody class="text-sm font-manrope font-bold">
                                            ...
                                            <tr class="odd:bg-oddgray even:bg-evengray">
                                                ...
                                                <th scope="row"
                                                    class="px-6 py-4 font-medium text-white whitespace-nowrap">
                                                    <div class="flex items-center gap-3 hyphens-auto">
                                                        <img src="{{ asset('assets/card-images/pikachu50.png') }}"
                                                            class="w-14 md:w-8" alt="">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="flex gap-1 items-center text-greenprice">
                                                        <svg width="18" height="18" viewBox="0 0 18 18"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M13.943 11.8538C14.2764 11.6082 14.3477 11.1387 14.1021 10.8051C13.9113 10.5461 13.7205 10.2998 13.5531 10.0853C13.2189 9.65724 12.759 9.08379 12.2592 8.50824C11.7627 7.93636 11.2121 7.34514 10.6982 6.89101C10.4421 6.66474 10.1773 6.45661 9.91915 6.30099C9.68163 6.15781 9.35523 5.99994 8.99815 5.99994C8.64108 5.99994 8.3146 6.15781 8.07708 6.30099C7.81893 6.45661 7.55425 6.66474 7.29813 6.89101C6.78416 7.34514 6.23363 7.93636 5.7371 8.50824C5.23734 9.08379 4.77735 9.65724 4.44321 10.0853C4.27583 10.2998 4.08499 10.5461 3.8942 10.8051C3.64857 11.1387 3.71981 11.6082 4.05333 11.8538C4.1874 11.9525 4.34344 12.0001 4.49809 11.9999H8.99815H13.4982C13.6528 12.0001 13.8089 11.9525 13.943 11.8538Z"
                                                                fill="#17D28B" />
                                                        </svg>
                                                        0.45
                                                    </div>
