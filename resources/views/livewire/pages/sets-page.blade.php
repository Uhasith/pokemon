                                    ...
                                    <div class="flex w-full">
                                        <div class="p-5 rounded-2xl bg-[#2C2C2C] bg-blend-screen w-full h-48 flex items-center justify-center">
                                            @if ($set->set_image !== null)
                                                <x-image class="sets-icon object-contain w-[60px] h-auto" :src="'https://www.pokemonprice.com/Content/images/sets/' . $set->set_image" :alt="$set->set_name" skeltonWidth="150" skeltonHeight="150" />
                                            @else
                                                <div class="flex items-center justify-center bg-gray-300 rounded dark:bg-gray-700 animate-pulse" style="width: 150px; height: 150px;">
